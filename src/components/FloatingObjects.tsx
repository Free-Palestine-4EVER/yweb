...
const FloatingObjects = () => {
  return (
    <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
      ...
      <div className="absolute top-1/3 -right-40 w-96 h-96 bg-gradient-to-bl from-dune-amber/5 to-dune-amber/10 rounded-full blur-3xl animate-float-reverse" />
      ...
      <div className="absolute bottom-1/3 left-1/2 w-3 h-3 bg-dune-amber/20 rounded-full animate-float-reverse animate-stagger-3" />
